...
class EvaluasiLatihanController extends Controller
{
    ...
    public function index(Request $request): Response
    {
        ...
        return Inertia::render('coach/TrainingSessions', [
            'sessions' => SesiLatihan::where('coach_id', $coachId)
     ...
     */
    public function show(SesiLatihan $session): Response
    {
        // Check authorization
     ...
     */
    public function updateEvaluation(UpdateEvaluationRequest $request, LogLatihan $log): RedirectResponse
    {
     ...
     * Delete a session.
     */
    public function destroy(SesiLatihan $session): RedirectResponse
    {
        if ($session->coach_id !== auth()->id()) {
            abort(403);
        }
