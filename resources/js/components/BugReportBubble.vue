...
<template>
    <!-- Floating Bubble -->
    <div class="fixed right-6 bottom-6 z-[9999]" style="position: fixed !important;">
        <button
            @click="isOpen = !isOpen"
                ...
                <form @submit.prevent="submit" class="space-y-4">
                    ...
                    <div class="space-y-1.5">
                        ...
                        <div class="relative">
                            ...
                            />
                            <div
                                style="border-color: rgba(255,255,255,0.1); background-color: rgba(255,255,255,0.05); color: #94a3b8;"
                                class="flex items-center gap-3 rounded-xl border border-dashed px-4 py-3 text-xs font-bold"
                            >
                                <Camera class="h-4 w-4" style="color: #ff6120;" />
                                <span
                                    v-if="form.image"
                                    style="color: #ffffff;"
                                    class="truncate"
