...
const breadcrumbs = [
    ...
    { title: 'Event & Target', href: '/manajemen/acara' },
];
...
const submit = () => {
    if (editingEvent.value) {
        form.patch(`/manajemen/acara/${editingEvent.value.id}`, {
            onSuccess: () => {
...
const deleteEvent = async (event: Event) => {
    if (
        ...
        router.delete(`/manajemen/acara/${event.id}`, {
...
const deleteType = async (id: number) => {
    if (
        ...
        router.delete(`/manajemen/tipe-acara/${id}`, {
...
const deletePoint = async (id: number) => {
    if (
        ...
        router.delete(`/manajemen/poin-acara/${id}`, {
            onSuccess: () =>
...
<template>
    <Head title="Event & Target - Manajemen" />
        ...
        >
            ...
            >
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        ...
                        >
                            Monitoring Agenda Event Semua Pelatih
                        </p>
                    </div>
                </div>
                <div class="flex items-center gap-4">
            ...
            >
                ...
                <div class="max-w-sm">
                    ...
                    >
                        Belum ada pelatih yang membuat agenda event.
                    </p>
                </div>
            </div>
                ...
                >
                    ...
                    >
                        <div>
                            ...
                            >
                                Manajemen dapat membuat agenda event global
                            </p>
                        </div>
                        <button
